...
function assembleCategory(categoryId, specs) {
  ...
  return specs.map((spec, i) => buildQuestion(categoryId, i, spec))
}
...
const READING_COMPREHENSION = [
  ...
  },
  {
    ...
    question: "A manager wants to approve a $6,200 purchase order. What does the policy require?",
    options: [
      "Manager may approve with CFO cc",
      "Director or higher must approve",
      "Split into two POs under $5,000",
      "VP approval always required over $5,000",
    ],
    correct: 1,
    resistance: "high",
  },
  ...
  },
  {
    ...
    question: "What must happen before `beta_reports` works for Acme?",
    options: [
      "Only toggle beta_reports",
      "Enable analytics_on then beta_reports",
      "Add Acme to allowed tenants",
      "Nothing — email is sufficient",
    ],
    correct: 1,
    resistance: "high",
  },
...
const ATTENTION_TO_DETAIL = [
  ...
  },
  {
    ...
    question: "Which rows suggest a duplicate or ID reuse error?",
    options: ["E102 only", "E104 only", "E102 and E104 share name/ID pattern issue", "No issue"],
    correct: 2,
    resistance: "high",
  },
  {
  ...
  },
  {
    ...
    artifact: "```yaml\n# staging.yaml\nrate_limit: 1000\nfeature_x: true\n\n# prod.yaml (exported)\nrate_limit: 100\nfeature_x: true\nfeature_y: true\n```",
    question: "Which prod setting differs from staging and could cause user-visible throttling?",
    options: ["feature_x", "feature_y only", "rate_limit", "Both rate_limit and feature_y"],
    correct: 2,
    resistance: "high",
  },
  {
...
const FOLLOWING_INSTRUCTIONS = [
  ...
  },
  {
    ...
    question: "Flight booked 5 days ahead for family event. Required documentation?",
    options: ["VP approval only", "Director email attached to expense report", "Incident ticket", "Nothing if under $500"],
    correct: 1,
    resistance: "high",
  },
  {
  ...
  },
  {
    ...
    question: "Rep applies 8% plus active 5% promo code. Allowed?",
    options: ["Yes, total 13% under manager cap", "No, stacking forbidden", "Yes, if VP approves", "Manager can stack"],
    correct: 1,
  },
  {
...
const APPLIED_NUMERACY = [
  ...
  },
  {
    ...
    question: "Additional charge for the upgrade this period?",
    options: ["$40.00", "$20.00", "$60.00", "$80.00"],
    correct: 0,
    resistance: "high",
  },
  {
...
const NUMERICAL_REASONING = [
  ...
  },
  {
    ...
    question: "Which grew faster percentage-wise?",
    options: ["Revenue (+15%)", "Customers (+15%)", "Revenue faster", "Customers faster"],
    correct: 3,
    resistance: "high",
  },
  {
  ...
  },
  {
    ...
    question: "Which scenario yields higher revenue index?",
    options: ["A (103.9)", "B (103.0)", "Tie", "A (102.5)"],
    correct: 0,
  },
  {
...
const CRITICAL_THINKING = [
  ...
  },
  {
    ...
    question: "Strongest rebuttal?",
    options: [
      "NPS cannot change",
      "Confounding event (outage fix) may explain NPS move",
      "Features never affect NPS",
      "Weekly NPS is precise",
    ],
    correct: 1,
    resistance: "high",
  },
  ...
  },
  {
    ...
    options: [
      "Math error only",
      "Linear extrapolation ignores saturation, churn, and seasonality",
...
const PROBLEM_SOLVING = [
  ...
  },
  {
    ...
    question: "Structured relief plan?",
    options: [
      "Close oldest tickets",
      "Triage by priority/impact, temporary macros, surge staffing, root-cause on top driver",
      "Stop taking tickets",
      "Raise prices",
    ],
    correct: 1,
  ...
  },
  {
    ...
    question: "Immediate risk mitigation?",
    options: [
      "Delay month-end",
      "Pair documentation/shadow run with backup owner before leave; freeze non-critical changes",
      "Run script blindly",
      "Outsource without context",
    ],
    correct: 1,
  },
  {
...
function main() {
  ...
  for (const categoryId of CATEGORIES) {
    ...
    specs.forEach((spec, i) => {
      ...
      if (type === "multiple_choice" && !spec.options) {
        throw new Error(`${categoryId}#${i} (${spec.tag}): MCQ slot missing options`)
      }
      if (type === "short_answer" && !spec.rubric?.trim()) {
        throw new Error(`${categoryId}#${i} (${spec.tag}): SA slot missing rubric`)
      }
    })
